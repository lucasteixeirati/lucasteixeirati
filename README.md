...
Atualmente, foco em unir a robustez da engenharia de software com a inovação da Inteligência Artificial:

* 🤖 **Desenvolvimento de Agentes de IA:** Focado na automação avançada de testes para otimização de processos.
* 🐍 **Engenharia de Software (Python & Java):** Implementação de soluções robustas para testes de intrusão e garantia de qualidade.
...
* **Automação:** Selenium, Robot Framework, Appium, JMeter.
* **Bancos de Dados:** SQL Server, Oracle (PL-SQL), DB2.
* **Ecosystem:** Jira, Git, IBM Toolset (RTC, RQM, RM, Cognos).
* **Processos:** UML, RUP, PDCA, Bizagi, ISO 9001/27002, ERP Protheus.

---

## 🏢 Minha Trajetória Completa

Sou movido por resultados e reconhecido pela minha **determinação**. Se tem um problema complexo, eu vou até o fim para resolver.

* **Zup/Itaú (Atual)** – Consolidação na área financeira e criando o futuro da qualidade de software com IA.
* **Stefanini/BNB (2020-2022)** – Ajudei a automatizar testes nos fluxos de **PIX**.
* **Engesoftware/BNB (2019-2020)** – Atuação cross como analista de requisitos e QA.
* **Qintess/BNB (2018-2019)** – Dominando ferramentas IBM e testes mainframe.
* **GREat (2017-2018)** – Primeiros passos com automação mobile e metodologia ágil.
* **M. Dias Branco (2014-2017)** – Onde descobri minha vocação em qualidade de software.
* **Gerardo Bastos (2013-2014)** – Primeira experiência em desenvolvimento como programador **ADVPL**.
* **Cosampa (2011-2013)** – Cuidando de redes, servidores Windows e suporte aos usuários.
* **Dytz Informática (2010)** – Início da graduação e estágio em BSB.

---

## 🏆 Certificações que conquistei

* ☁️ **AWS Generative AI Practitioner** (2026)
...
**"A vida é como um código: às vezes dá erro, mas sempre tem como debugar!"** 🐛✨
